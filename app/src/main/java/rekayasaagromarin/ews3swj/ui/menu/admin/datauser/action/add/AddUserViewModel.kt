...
class AddUserViewModel : ViewModel() {
    ...
    fun addUser(name: String, email: String, password: String, membership_id: Int, role_id: Int) {
        _isLoading.value = true
        val client =
            ApiConfig.getApiService().addUser(name, email, password, membership_id, role_id)
